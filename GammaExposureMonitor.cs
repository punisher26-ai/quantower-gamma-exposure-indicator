...
namespace Indicator33
{
    ...
    {
        #region Parameters
        [InputParameter("Strike Range", 0, 1, 50, 1, 0)]
        public int StrikeRange = 10;

        [InputParameter("GEX Threshold (Million)", 1, 0.1, 100, 0.1, 1)]
        public double GexThreshold = 1.0;

        [InputParameter("Update Frequency (ms)", 2, 500, 10000, 100, 0)]
        public int UpdateFrequency = 2000;

        [InputParameter("Show Gamma Levels", 3)]
        public bool ShowGammaLevels = true;

        [InputParameter("Show GEX Values", 4)]
        public bool ShowGexValues = true;

        [InputParameter("Alert on Critical Levels", 5)]
        ...
        {
            // Convert GexThreshold from millions to actual value
            GexThreshold = GexThreshold * 1000000;
